...
public class UserHomepageUI {
	...
	public static final String LOGIN_USERNAME_TEXTBOX = "css=div#loginPanel input[name='username']";
	public static final String LOGIN_PASSWORD_TEXTBOX = "css=div#loginPanel input[name='password']";
